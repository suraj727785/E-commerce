...
<?php
    ...
    echo "<td><a href='users.php?change_to_salesman={$user_id}'>Salesman</a></td>";
...
header("Location: users.php");
 ...
 if(isset($_GET['change_to_salesman'])){
     
$change_to_sub = $_GET['change_to_salesman'];
$query= "UPDATE users SET user_role ='Salesman' WHERE user_id=$change_to_sub ";
$change_to_sub_query = mysqli_query($connection,$query);
